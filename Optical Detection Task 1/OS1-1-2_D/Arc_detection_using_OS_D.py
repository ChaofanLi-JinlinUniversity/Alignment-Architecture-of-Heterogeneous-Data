...
seted_parameter = {'setted_tif_path':'dynamic_threshold_adaptivecutted_tif','setted_background_path':'background',
                   'setted_img_transform_height':224,'setted_img_transform_width':224,
                   'setted_start_1':1134,'setted_end_1':41637,
                   'output_file_name':'112output_D.xlsx'
                  }
...
trained_model = torch.load('model_squeezenetD1_non89.pt')
...
self_dataset = DataLoader(self_dataset,256,shuffle=False)
