...
def signal_cutting_and_output_SFT_cycle( cycle_start_number,cycle_interval,cycle_end_number,time_shift_length,
    ...
    saved_file_list = [f"1MHz_SFT_and_alignment_of_optical_and_acoustic_signals/SFT_log_{log_process}_time_shift_{time_shift_length}_{i}" for i in range(cycle_start_number, cycle_end_number+1,cycle_interval)]
