...
seted_parameter = {'setted_data_path':'cutted_png',
                   'setted_img_transform_height':224,'setted_img_transform_width':224,
                   'setted_batch_size':128,'seted_num_epochs':100, 'seted_lr':0.002,
                   'setted_loss_and_accuracy_file_name':'Loss_and_accuracy_2-3IS_and_label',
                   'setted_start_cycle_number':-8,'setted_end_cycle_number':8,'seted_sample_number/2':2500,
                  }
label_path =  r'2-2label&IS_80Hz.xlsx'
...
for cyclic_number in cyclic_array:
	...
	#处理时移数据和采样数据建立数据集
	prcessed_png_list = png_list[100+cyclic_number:75800+cyclic_number]
	#print(f'prcessed_png_list_len:',len(prcessed_png_list))
	#print(prcessed_png_list)

	processed_label_data = label_data[100:75800]
	print(100+cyclic_number)
	label_0_index = []
	label_1_index = []
