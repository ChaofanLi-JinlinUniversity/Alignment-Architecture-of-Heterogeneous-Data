...
seted_parameter = {'setted_tif_path_1':'2-2/cutted_tif','setted_tif_path_2':'2-3/cutted_tif',
...
def train(model, num_epochs, train_d1, valid_d1,path):
	...
	for epoch in range(num_epochs):
		...
		torch.save(model, os.path.join(path,'model_squeezenet1_{}.pt'.format(epoch+1)))
...
df_hist.to_excel(os.path.join(seted_parameter['model_and_loss_accuracy_path'],'Hist_loss_and_accuracy.xlsx'), index=False, header=['Epoch','Train_loss','Valid_loss','Train_acc','Valid_acc','TP','TN','FP','FN'])