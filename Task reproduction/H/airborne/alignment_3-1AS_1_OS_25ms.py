...
seted_parameter = {'setted_SFT_path':'SFT_log_0_time_shift_0.001_0',
                   ...
                   'setted_loss_and_accuracy_file_name':'Loss_and_accuracy_AS_1_and_OS_25ms',
                   'setted_start_cycle_number':-86,'setted_end_cycle_number':-26,'seted_sample_number/2':5000,
                  }
...
for cyclic_number in cyclic_array:
	...
	#处理时移数据和采样数据建立数据集
	prcessed_png_list = png_list[1500+cyclic_number:36000+cyclic_number]
