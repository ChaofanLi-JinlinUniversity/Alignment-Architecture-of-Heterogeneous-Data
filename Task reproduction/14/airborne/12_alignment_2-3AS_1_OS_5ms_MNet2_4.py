...
seted_parameter = {'setted_SFT_path':['SFT_log_0_time_shift_0.001_0','SFT_log_0_time_shift_0.001_5','SFT_log_0_time_shift_0.001_10','SFT_log_0_time_shift_0.001_15','SFT_log_0_time_shift_0.001_20'],
                   ...
                   'setted_loss_and_accuracy_file_name':'Loss_and_accuracy_AS_1_and_OS_5ms_MNet2_4','seted_sample_number/2':4500,
...
class MiniCNN4(nn.Module):
    def __init__(self):
        ...
        self.feature = nn.Sequential(nn.Conv2d(3, 4, kernel_size=3, stride=2, padding=1,bias=False),
                                    nn.BatchNorm2d(4),
                                    nn.ReLU(),
                                    nn.AvgPool2d(32),
                                    nn.Flatten()
