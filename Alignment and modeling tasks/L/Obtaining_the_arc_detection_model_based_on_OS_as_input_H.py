...
seted_parameter = {'setted_tif_path_1':'2-2/histogram_equalization_tif','setted_tif_path_2':'2-3/histogram_equalization_tif',
                   ...
                   'setted_batch_size':128,'seted_num_epochs':100, 'seted_lr':0.00001,
                   'model_and_loss_accuracy_path':'Model_Loss_and_Accuracy_H'
                  }
...
def train(model, num_epochs, train_d1, valid_d1,path):
	...
	for epoch in range(num_epochs):
		...
		torch.save(model, os.path.join(path,'model_squeezenetH1_{}.pt'.format(epoch+1)))
...
df_hist.to_excel(os.path.join(seted_parameter['model_and_loss_accuracy_path'],'Hist_loss_and_accuracyH.xlsx'), index=False, header=['Epoch','Train_loss','Valid_loss','Train_acc','Valid_acc','TP','TN','FP','FN'])